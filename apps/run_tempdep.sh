...
#SBATCH --time=03:00:00      # 5 trials × ~11 min each + margin
#SBATCH --output=/home/hpc/iwia/iwia133h/.local/materforge/apps/logs/run_tempdep.log
#SBATCH --error=/home/hpc/iwia/iwia133h/.local/materforge/apps/logs/run_tempdep.err
...
BIN=/home/hpc/iwia/iwia133h/.local/materforge/apps/build/woody-release-cpu/CouetteFlowScaling_tempdep
