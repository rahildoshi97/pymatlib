...
#SBATCH --time=02:30:00      # 5 trials x ~9 min each + margin
#SBATCH --output=/home/hpc/iwia/iwia133h/.local/materforge/apps/logs/performance/run_perf_const.log
#SBATCH --error=/home/hpc/iwia/iwia133h/.local/materforge/apps/logs/performance/run_perf_const.err
...
BIN=${APPS_DIR}/build/woody-release-cpu/CouetteFlowScaling_const_0.08
...
# ranks 0-3 on cores 0-3 of socket 0 - same NUMA domain, consistent L3 reuse.
